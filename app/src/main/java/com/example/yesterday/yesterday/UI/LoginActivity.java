...
import com.example.yesterday.yesterday.sqlite.LoginDB;
...
public class LoginActivity extends AppCompatActivity {
    ...
    final LoginDB dbHelper = new LoginDB(getApplicationContext(), "Login.db", null, 1);
    ...
    public void MyLogin(String id, String pw) {
        ...
        try {
            ...
            result = dbHelper.getResult(id,pw);
        } catch (Exception e) {
            e.getMessage();
        }
